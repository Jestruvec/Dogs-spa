PARA VISUALIZAR EL PROYECTO ES NECESARIO EJECUTAR EL COMANDO NPM STAR EN LA TERMINAL DESDE LA CARPETA API, LUEGO NPM START EN LA TERMINAL DESDE LA CARPETA CLIENT.
